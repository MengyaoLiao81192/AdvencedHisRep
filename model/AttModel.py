...
class AttModel(Module):
    ...
    def forward(self, src, output_n=25, input_n=50, itera=1):
        ...
        for i in range(itera):
            ...
            # key_tmp = 0.99*key_tmp + 0.01*query_tmp
            
            score_tmp = torch.matmul(query_tmp.transpose(1, 2), key_tmp) + 1e-15
            
            # if self.previous_tmp is None:
            #     self.previous_tmp = torch.zeros_like(score_tmp)
            # score_tmp += 0.01*self.previous_tmp
            # self.previous_tmp = score_tmp
            ...
            if itera > 1:
                ...
                # key_new = 0.99*key_tmp + 0.01*query_tmp
